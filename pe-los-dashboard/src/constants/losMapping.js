...
export const ARIES_INPUT_FIELDS = [
  ...
  { key: 'varOilPerBOE',           label: 'Oil Unit Cost',      unit: '$/Gross BBL',     lowerIsBetter: true,  histKey: 'varOilPerBOE', fmt: v => `$${Number(v).toFixed(2)}` },
  { key: 'gptPerMcf',              label: 'GP&T',               unit: '$/Gross Mcf',     lowerIsBetter: true,  histKey: 'gptPerMcf',    fmt: v => `$${Number(v).toFixed(3)}` },
  { key: 'midstreamPerMcf',        label: 'Midstream Revenue',  unit: '$/Gross Mcf',     lowerIsBetter: false, histKey: 'midstreamPerMcf', fmt: v => `$${Number(v).toFixed(3)}` },
...
export const ARIES_IMPORT_KEY_MAP = {
  ...
  'Oil Unit Cost':                   'varOilPerBOE',
  'Variable Oil Costs':              'varOilPerBOE',
  'GP&T':                            'gptPerMcf',
  'Midstream Revenue':               'midstreamPerMcf',
  'Water Unit Cost':                 'varWaterPerBBL',
  ...
  'Oil Unit Cost ($/Gross BBL)':    'varOilPerBOE',
  'Variable Oil ($/BOE)':           'varOilPerBOE',
  'GP&T ($/Gross Mcf)':             'gptPerMcf',
  'GP&T ($/Mcf)':                   'gptPerMcf',
  'GP&T ($/BOE)':                   'gptPerMcf',
  'Midstream Revenue ($/Gross Mcf)': 'midstreamPerMcf',
  'Midstream Revenue ($/Net Mcf)':   'midstreamPerMcf',
  'Water Unit Cost ($/Gross BBL water)': 'varWaterPerBBL',
...
export const TABS = [
  ...
  { id: 'inputcharts',     label: 'Input Charts' },
