...
export const ARIES_INPUT_FIELDS = [
  ...
  { key: 'gptPerMcf',              label: 'GP&T',               unit: '$/Mcf',           lowerIsBetter: true,  histKey: 'gptPerMcf',    fmt: v => `$${Number(v).toFixed(3)}` },
  { key: 'midstreamPerMcf',        label: 'Midstream Revenue',  unit: '$/Net Mcf',       lowerIsBetter: false, histKey: 'midstreamPerMcf', fmt: v => `$${Number(v).toFixed(3)}` },
