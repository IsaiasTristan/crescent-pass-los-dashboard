...
export const WBW_TYPES = [
  ...
  { id:'nglDifferential', group:'Realized Prices', label:'NGL Diff ($/Bbl)',     pk:'nglDifferential',  chartType:'single', fill:C.differential, fmt:fB,      tableFmt:n=>n.toFixed(2),       tableLabel:'NGL Differential ($/Bbl)'   },
