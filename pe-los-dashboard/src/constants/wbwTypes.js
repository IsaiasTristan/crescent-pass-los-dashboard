...
export const WBW_TYPES = [
  ...
  { id:'oilSevTaxm',    group:'Taxes',            label:'Oil Sev Tax ($MM)',     pk:'prod_tax_oil',     chartType:'single', fill:C.oil,       fmt:fMdol,       tableFmt:n=>(n/1e6).toFixed(1), tableLabel:'Oil Severance Tax ($MM)'     },
  { id:'gasSevTaxm',    group:'Taxes',            label:'Gas Sev Tax ($MM)',     pk:'prod_tax_gas',     chartType:'single', fill:C.gas,       fmt:fMdol,       tableFmt:n=>(n/1e6).toFixed(1), tableLabel:'Gas Severance Tax ($MM)'     },
  { id:'nglSevTaxm',    group:'Taxes',            label:'NGL Sev Tax ($MM)',     pk:'prod_tax_ngl',     chartType:'single', fill:C.ngl,       fmt:fMdol,       tableFmt:n=>(n/1e6).toFixed(1), tableLabel:'NGL Severance Tax ($MM)'     },
  { id:'adValTaxm',     group:'Taxes',            label:'Ad Valorem ($MM)',      pk:'ad_valorem_tax',   chartType:'single', fill:C.prodTaxes, fmt:fMdol,       tableFmt:n=>(n/1e6).toFixed(1), tableLabel:'Ad Valorem Tax ($MM)'        },
  { id:'oilSevTaxPct',  group:'Taxes',            label:'Oil Sev (% Rev)',       pk:'oilSevTaxPct',     chartType:'single', fill:C.oil,       fmt:fP,          tableFmt:n=>n.toFixed(2),       tableLabel:'Oil Severance Tax (% Rev)'  },
  { id:'gasSevTaxPct',  group:'Taxes',            label:'Gas Sev (% Rev)',       pk:'gasSevTaxPct',     chartType:'single', fill:C.gas,       fmt:fP,          tableFmt:n=>n.toFixed(2),       tableLabel:'Gas Severance Tax (% Rev)'  },
