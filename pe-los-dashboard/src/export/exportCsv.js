  ...
  for (const w of wellData) {
    for (const m of w.monthlyData) {
      rows.push({
        ...
        'Water Unit Cost ($/Gross BBL water)': m.varWaterPerBBL != null ? m.varWaterPerBBL.toFixed(4) : '',
        'GPT ($)':              m.gpt.toFixed(0),
        ...
        'GP&T ($/Gross Mcf)':   m.gptPerMcf.toFixed(4),
        'Midstream ($/Gross Mcf)': m.midstreamPerMcf.toFixed(4),
